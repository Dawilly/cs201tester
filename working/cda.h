...
extern CDA *newCDA(void); //Made void
extern void setCDAdisplay(CDA *items, void(*display)(void *, FILE *)); //added
extern void setCDAfree(CDA *items, void(*free)(void *));
extern void insertCDA(CDA *items, int index, void *value); //added
extern void *removeCDA(CDA *items, int index); //added
